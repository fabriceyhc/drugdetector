...
CUDA_VISIBLE_DEVICES=7 python -m drugdetector.dspy.eval --model_id aaditya/Llama3-OpenBioLLM-8B --chat_template ./drugdetector/dspy/chat_templates/llama-3-instruct.jinja
