...
# CUDA_VISIBLE_DEVICES=3 python -m drugdetector.dspy.singlelabel.annotate --model_id deepseek-ai/DeepSeek-R1-Distill-Llama-8B
# CUDA_VISIBLE_DEVICES=3 python -m drugdetector.dspy.multilabel.annotate  --model_id deepseek-ai/DeepSeek-R1-Distill-Llama-8B
